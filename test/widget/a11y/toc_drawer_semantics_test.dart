      ...
      await withSemanticsAudit(tester, () async {
        ...
        for (final heading in headings) {
          expect(
            ...
            reason:
                'TOC entry "${heading.text}" must have button semantics and '
                'its text as the semantic label so screen readers announce '
                'both the heading name and the tap affordance.',
          );
        }
