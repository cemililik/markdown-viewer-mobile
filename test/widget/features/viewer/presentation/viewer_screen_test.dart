  ...
  group('ViewerScreen', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(find.byTooltip(l10n.viewerSearchOpenTooltip), findsOneWidget);
        expect(find.byTooltip(l10n.viewerTocOpenTooltip), findsOneWidget);
        expect(
          find.byTooltip(l10n.viewerReadingPanelOpenTooltip),
          findsOneWidget,
        );
      },
    );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.tap(find.byTooltip(l10n.viewerReadingPanelOpenTooltip));
        await tester.pumpAndSettle();
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.tap(find.byTooltip(l10n.viewerSearchOpenTooltip));
        await tester.pumpAndSettle();

        // The AppBar title stays; the bottom search bar slides in
        // with a close button and a search hint in the text field.
        expect(find.text('example.md'), findsOneWidget);
        expect(find.byTooltip(l10n.viewerSearchCloseTooltip), findsOneWidget);
      },
    );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.tap(find.byTooltip(l10n.viewerTocOpenTooltip));
        await tester.pumpAndSettle();
