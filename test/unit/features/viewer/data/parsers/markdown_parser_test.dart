...
void main() {
  ...
  group('MarkdownParser', () {
    test(
      'should return an empty document for empty input when the behavior is exercised',
      () {
    ...
    test(
      'should strip a UTF-8 BOM from the decoded source when the behavior is exercised',
      () {
    ...
    test(
      'should extract a single heading from a minimal document when the behavior is exercised',
      () {
    ...
    test(
      'should extract headings in document order with stable anchors when the behavior is exercised',
      () {
    ...
    test(
      'should walk containers recursively to find nested headings when the behavior is exercised',
      () {
    ...
    test(
      'should ignore non-heading top-level blocks when the behavior is exercised',
      () {
    ...
    test(
      'should throw FormatException on invalid UTF-8 when the behavior is exercised',
      () {
    ...
    test(
      'should count lines for a terminal newline correctly when the behavior is exercised',
      () {
        const source = 'a\nb\nc\n';
    ...
    test(
      'should stamp each heading with the top-level block it lives in when the behavior is exercised',
      () {
    ...
    test(
      'should confirm that nested headings carry the block index of their enclosing container when the behavior is exercised',
      () {
