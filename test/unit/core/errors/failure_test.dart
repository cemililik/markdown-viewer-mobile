...
void main() {
  group('Failure', () {
    test(
      'should expose a stable tree-shake-safe name for each subtype when the behavior is exercised',
      () {
    ...
    test(
      'should implement Exception so repositories can throw them when the behavior is exercised',
      () {
    ...
    test(
      'should render message and type in toString without a cause when the behavior is exercised',
      () {
    ...
    test(
      'should emit only the cause type in toString, never the value when the behavior is exercised',
      () {
    ...
    test(
      'should allow exhaustive switch over all subtypes when the behavior is exercised',
      () {
