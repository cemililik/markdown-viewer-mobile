// Pure-function helpers for mermaid source processing that no
// longer belong in the data layer — the logic has no I/O, no
// platform channel, no WebView. Moving it out keeps the
// presentation layer (mermaid_block) from reaching across into
// `data/` just to call a string-slicing helper, which was the
// layer-matrix violation filed as code-review CR-20260419-006.
